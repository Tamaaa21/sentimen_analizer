...
<head>
    ...
    <meta name="description" content="Login to access Sentiment Analyzer">
    <!-- Tailwind CSS -->
...
<body class="animated-gradient min-h-screen flex items-center justify-center p-4">
    <div class="glass-card rounded-xl overflow-hidden shadow-xl w-full max-w-md">
        <div class="bg-gradient-to-r from-indigo-500 to-purple-600 text-white p-6">
            ...
            <p class="text-center text-white/80">Login untuk mengakses aplikasi</p>
        </div>
        <div class="p-6">
            @if($errors->any())
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email') }}" required autofocus class="w-full rounded-md border-2 border-indigo-100 focus:border-indigo-300 p-3 transition-all" placeholder="nama@example.com">
                </div>
